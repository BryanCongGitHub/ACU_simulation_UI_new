...
class ACUSimulator(QMainWindow):
    ...
    def _init_sidebar_dock(self, legacy_left_panel: QWidget):
        ...
        if SEND_START_TIME_FIELDS:
            start_time_group = QGroupBox("启动时间 (秒)")
        ...
        env_form.addRow("电池温度(°C)", self.sc_battery_temp_spin)
